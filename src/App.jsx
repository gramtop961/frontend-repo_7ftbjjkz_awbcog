    ...
    <div className="min-h-screen bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100 scroll-smooth">
        ...
        <Section id="services" title="Services" description="Four disciplines—built to move brands with clarity and confidence.">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[{
              ...
              <div key={s.name} className="rounded-lg border border-neutral-200 dark:border-neutral-800 p-6">
          ...
          <div className="mt-6">
            <a href="#contact" className="inline-flex items-center justify-center px-5 py-3 rounded-md bg-indigo-600 text-white font-semibold shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500">Start a project</a>
          </div>
        </Section>
        ...
        <Section id="about" title="About" description="Designer & editor focused on purposeful visuals and motion.">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            <div className="md:col-span-1">
              <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=600&auto=format&fit=crop" alt="Portrait" className="w-full aspect-square object-cover rounded-lg border border-neutral-200 dark:border-neutral-800" loading="lazy" />
            </div>
        ...
        <Section id="contact" title="Contact" description="Tell me about your project—let’s build something clear, confident, and moving.">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <form onSubmit={onSubmit} className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                <button type="submit" className="inline-flex items-center justify-center px-5 py-3 rounded-md bg-indigo-600 text-white font-semibold shadow-sm">Send</button>
                {submitted && (
      ...
      {showTop && (
        <button
          ...
          className="fixed bottom-6 right-6 p-3 rounded-full bg-neutral-900 text-white dark:bg-neutral-100 dark:text-neutral-900 shadow-md"
        >
          ↑
        </button>
      )}
